...
class ResponceMaster extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('responce_id, option_value, responce_text, responce_audio_url, responce_vedio_url, created_at, question_id, client_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('responce_id',$this->responce_id);
